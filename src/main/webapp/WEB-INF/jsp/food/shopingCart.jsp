        ...
        <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                	<td class="product-close"><input type="checkbox" onClick="itemSum()"
										class="chkbox" value="${cartList.proPrice * cartList.cartStock}"
										data-cartNum="${cartList.cartSeq}" /></td>
                                    ...
                                    <td class="shoping__cart__item__close" id="delete_${cartList.cartSeq}_btn"
										data-cartNum="${cartList.cartSeq}">
                                        <span class="icon_close"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="/images/flowers/thumb_open_table_60x60.jpg" alt="">
                                        <h5>개업축하_테이블야자</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        70,000
            ...
            <div class="row">
              ...
              <c:if test="${not empty cartList}">          
                        <a href="${path}/order/clientCheckOut/${myOrderSerialNum}" class="primary-btn">PROCEED TO CHECKOUT</a>
              </c:if>      
                    </div>
                </div>
            </div>
